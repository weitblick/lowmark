...
$lowmark = [
    ...
    'image_resize'        => '720x', // Enable image resizing if set. Use format WIDTHxHEIGHT (in pixels) for cropping. Use only WIDTH (e.g. '720x') or only HEIGHT (e.g. 'x480') for proportional scaling.
